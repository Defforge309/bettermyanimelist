        ...
        for (let i = mutations.length; i--;) {
            ...
            for (let ii = mutation.addedNodes.length; ii--;) {
                ...
                if (addedNode.id === "searchBar" && addedNode.querySelector("#topSearchText") !== null && addedNode.querySelector("#topSearchValue") !== null) {
                    ...
                    autocomplete.query = "";
                    addedNode.querySelector("#topSearchText").addEventListener("input", function(event) {
                    ...
                    addedNode.querySelector("#topSearchText").addEventListener("click", function(event) {
